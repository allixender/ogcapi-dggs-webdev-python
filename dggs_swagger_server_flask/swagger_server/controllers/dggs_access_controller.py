...
from swagger_server.models.exception import DggsException, DggsCollectionIdNotFoundError  # noqa: E501
...
def collections_collection_id_zone_zone_id_buffer_get(collection_id, zone_id, distance=None, project_to=None):  # noqa: E501
...
def collections_collection_id_zone_zone_id_child_get(collection_id, zone_id, inherit_id=None, levels=None):  # noqa: E501
    """Get the list of zones children of a given zone (should it return just a list of identifiers instead of a GeoJSON collection?)
...
def collections_collection_id_zones_get(collection_id, resolution, bbox=None, zone_id_list=None, limit=None):  # noqa: E501
