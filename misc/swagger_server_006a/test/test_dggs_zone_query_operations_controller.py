...
class TestDGGSZoneQueryOperationsController(BaseTestCase):
    """DGGSZoneQueryOperationsController integration test stubs"""

    def test_dggs_dggs_rsid_zone_zonal_id_distance_get(self):
        """Test case for dggs_dggs_rsid_zone_zonal_id_distance_get
        ...
        response = self.client.open(
            '/apis/geofizzydrink/ogc_api_dggs/0.0.6/dggs/{dggsRSID}/zone/{ZonalID}/distance'.format(dggs_rsid='dggs_rsid_example'),
            method='GET',
