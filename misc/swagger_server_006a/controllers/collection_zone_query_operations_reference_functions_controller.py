...
def collections_collection_id_dggs_dggs_rsid_zone_zonal_id_relate_get(collection_id, dggs_rsid, zonal_id, matrix=None, project_to=None):  # noqa: E501
...
def collections_collection_id_dggs_dggs_rsid_zone_zonal_id_relate_position_get(collection_id, dggs_rsid, zonal_id, relate=None, project_to=None):  # noqa: E501
