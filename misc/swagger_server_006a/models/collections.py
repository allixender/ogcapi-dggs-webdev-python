...
class Collections(Model):
    ...
    """
    def __init__(self, links: List[Link]=None, id: str=None, title: str=None, description: str=None, keywords: List[Keyword]=None, attribution: str=None, extent: Extent=None, crs: List[str]=None):  # noqa: E501
