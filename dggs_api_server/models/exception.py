...
class DggsException(Model):
    ...
    def __init__(self, code: str = None, description: str = None):  # noqa: E501
        ...
        """
        self.swagger_types = {"code": str, "description": str}

        self.attribute_map = {"code": "code", "description": "description"}
        self._code = code
...
class DggsTypeNotSupportedError(DggsException):
    def __init__(self):
        code = "NOT_IMPLEMENTED"
        description = "dggs_type not implemented"
        super().__init__(code, description)
