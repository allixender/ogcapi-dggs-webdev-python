...
def collections_collection_id_zone_zone_id_buffer_get(
    collection_id, zone_id, dist=None, range_refine=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_child_get(
    collection_id, zone_id, inherit_id=None, levels=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_difference_get(
    collection_id, zone_id, zonal_id, range_refine=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_intersection_get(
    collection_id, zone_id, zonal_id, range_refine=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_parent_get(
    collection_id, zone_id, inherit_id=None, levels=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_sibling_get(
    collection_id, zone_id, inherit_id=None, levels=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_sym_difference_get(
    collection_id, zone_id, zonal_id, range_refine=None, project_to=None
):  # noqa: E501
...
def collections_collection_id_zone_zone_id_union_get(
    collection_id, zone_id, zonal_id, range_refine=None, project_to=None
):  # noqa: E501
