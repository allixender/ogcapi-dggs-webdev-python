...
def dggs_dggs_rsid_zone_zonal_id_relate_get(dggs_rsid, zonal_id, matrix=None, project_to=None):  # noqa: E501
...
def dggs_dggs_rsid_zone_zonal_id_relate_position_get(dggs_rsid, zonal_id, relate=None, project_to=None):  # noqa: E501
